    ...
    <div class="form_container">
        <form method="POST" action="{{url('/redirect/admin-subcategory-edit', $subcategory_with_id->subcategory_id)}}">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="category_id" id="{{$data->category_name}}" value="{{$data->category_id}}" {{ $subcategory_with_id->category_id == $data->category_id ? 'checked' : '' }}>
            ...
            <div class="input_container">
                ...
                <input type="text" class="form-control" id="subcategory_name" name="subcategory_name" value="{{$subcategory_with_id->subcategory_name}}">
            </div>
